...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(995, 842)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(460, 300, 71, 41))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.foo)
        self.rootImage = QtWidgets.QLabel(self.centralwidget)
        self.rootImage.setGeometry(QtCore.QRect(20, 80, 431, 501))
        ...
        self.resImage.setGeometry(QtCore.QRect(550, 80, 431, 501))
        ...
        self.resContent.setGeometry(QtCore.QRect(90, 590, 841, 201))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rootImage.setText(_translate("MainWindow", "TextLabel"))
        self.resImage.setText(_translate("MainWindow", "TextLabel"))
        self.resContent.setText(_translate("MainWindow", "TextLabel"))

    def get_image(self):        
        dlg = QFileDialog()
        filename, _ = dlg.getOpenFileName(self.centralwidget, "Open any file", r"/home/xuanhoang232k/Pictures/")
